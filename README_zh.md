...
> [!TIP]
> <details>
> <summary><b> 或使用极简版（约6GB，若已有ComfyUI和部分模型可选）</b></summary>
>   
> - 1.下载项目中的所有文件（通过'git clone'，或直接在项目主页点击'Code -> Download ZIP'后解压）。
> - 2.从完整版链接中下载环境库[python.zip](https://pan.baidu.com/s/1lJ3WSWmI-Zbt7jaSvYEyLA?pwd=gxyt)（约6GB），解压到根目录。<b>确保有一个'python'的文件夹，打开后能看到'python.exe'（而不是套着第二层文件夹）。</b>
